            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">$4.999.900</h5>
                        <p class="card-text">Triple camara trasera, procesador A13 Bionic, memoria interna de 256/512 GB y batería de 3.900 mAh.</p>
                        <a href="#" data-id="1" class="btn btn-primary">Añadir al carrito</a>
                    </div>
=======
...
>>>>>>> 729123d3c251928c74ff5e1ff4ee11866fe2b722
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" data-id="2" class="btn btn-primary">Añadir al carrito</a>
                    </div>
=======
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title precio" value="5149900">$5.149.900</h5>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" data-id="3" class="btn btn-primary">Añadir al carrito</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Samsung Galaxy A51</h4>
                        <h5 class="card-title">$1.199.900</h5>
                        <p class="card-text">Cuatro camaras traseras, procesador Exynos 9611, memoria interna de 128 GB y batería de 4.000 mAh.</p>
                        <a href="#" data-id="4" class="btn btn-primary">Añadir al carrito</a>
                    </div>
=======
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="card" style="width: 18rem;">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" data-id="5" class="btn btn-primary">Añadir al carrito</a>
                    </div>
=======
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="card" style="width: 18rem;">
...
<<<<<<< HEAD
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Nokia 3.4</h4>
                        <h5 class="card-title">$549.900</h5>
                        <p class="card-text">Triple camara trasera, procesador Qualcomm Snapdragon 460, memoria interna de 64 GB y batería de 4.000 mAh.</p>
                        <a href="#" data-id="6" class="btn btn-primary">Añadir al carrito</a>
                    </div>
=======
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="card" style="width: 18rem;">
